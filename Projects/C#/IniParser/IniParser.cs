...
namespace IniParser
{
	...
	public class CIniParser
	{
		...
		/// <param name="section">Section to look in. If null, it will look in default section [Vapor]</param>
		...
		/// </summary>
		/// <param name="key">Target key</param>
		/// <param name="section">ection to look in. If null, it will look in default section [Vapor]</param>
		...
		/// <param name="section">Section to write in. If null, it will write in the default section [Vapor]</param>
		...
		/// </summary>
		/// <param name="section">Section to delete. If null, it will delete the default section [Vapor]</param>
		...
		private void WriteComment(string message, string key = null, string section = null)
		{
		...
		/// </summary>
		/// <param name="section">Section to read. If null, default section wil be read [Vapor]</param>
